export const experiences = [
	...
	{
		company: 'Université de la République',
		time: '1934 - 1945',
		title: 'Professor',
...
export const publications = [
  ...
  },
  {
    ...
    authors: "Alejandro Vásquez-Echeverría, Lucía Alvarez-Nuñez, Meliza Gonzalez, Tianna Loose, Fanny Rudnitzky",
    journal: "Early Human Development 149, 105157",
    time: "2020",
    link: "https://cibpsi.psico.edu.uy/cibpsi.psico.edu.uy/sites/default/files/Psychometric%20properties%20of%20the%20Spanish%20version%20of%20the%20Ages%20%26%20Stages%20Questionnaires%20Social%E2%80%93Emotional%20in%20a%20nationally%20representative%20sample/index.pdf",
  ...
  },
  {
    ...
    journal: "Personality and Individual Differences 123, 171-175",
    time: "2018",
    link: "https://www.sciencedirect.com/science/article/abs/pii/S0163638322000157",
  ...
  },
  {
    ...
    journal: "Early Human Development 157, 105367",
    time: "2021",
    link: "https://www.sciencedirect.com/science/article/abs/pii/S0378378221000669",
    abstract: "This study evaluates the reliability and factor solution of the Spanish version of the ASQ-3 (18- to 54-month questionnaires) in a large, representative sample of Uruguayan children. Besides, it explores the association of ASQ-3 scores with sociodemographic characteristics."
  },
  {
    ...
    journal: "Early Child Development and Care 192 (12), 1857-1875.",
    time: "2021",
  ...
  },
  {
    ...
    journal: "Current Psychology 42 (17), 14440-14451",
    time: "2022",
  ...
  },
  {
    ...
    authors: "Alejandro Vásquez-Echeverría, Lucía Alvarez-Nuñez, Zena Mello, Frank C Worrell",
  ...
  },
  {
    ...
    journal: "Child Psychiatry & Human Development 51 (5), 801-812",
    time: "2020",
  ...
  {
    title: "Confiabilidad y validez de la escala consideración de las consecuencias futuras en español: como pensamos en las consecuencias inmediatas (pero no las distantes) de nuestras ...",
  ...
  },
  {
    ...
    journal: "Current Psychology 42 (32), 28406-28416",
    time: "2023",
    link: "https://scholar.google.com/citations?view_op=view_citation&hl=es&user=WpzOV1EAAAAJ&citation_for_view=WpzOV1EAAAAJ:hqOjcs7Dif8C",
  ...
  {
    title: "Trayectorias académicas en la Universidad de la República. El rol de los factores sociodemográficos y psicológicos en el abandono en dos servicios altamente masificados1",
  ...
  {
    title: "¿ Cómo resolvemos los dilemas entre los beneficios presentes y los futuros? Teoría y evaluación de la consideración de las consecuencias futuras",
    authors: "Lucía Alvarez-Nuñez, Alejandro Vásquez-Echeverría",
    journal: "Prólogo de Diego Golombek., 125",
    time: "2020",
    ...
    abstract: "Diariamente tomamos decisiones en las cuales debemos sopesar entre las consecuencias inmediatas y distantes de nuestras acciones. Por ejemplo, los estudiantes universitarios habitualmente deben decidir si salen un fin de semana con sus amigos (lo cual les brinda satisfacción y placer inmediato) o se quedan en su hogar estudiando (acción que conllevaría mayor probabilidad de aprobar futuras evaluaciones). Para comprender y explicar cómo las personas resuelven los dilemas temporales Strathman, Gleicher, Boninger, y Edwards (1994) propusieron el constructo Consideración de las Consecuencias Futuras (ccf). Desde este constructo se considera que las personas resuelven los dilemas temporales eligiendo y prefiriendo ya sea las consecuencias inmediatas o las distantes de sus comportamientos (Strathman, Gleicher, Boninger y Edwards, 1994). La ccf define el grado en que las personas sopesan y son influenciadas por los resultados inmediatos y distantes de sus acciones. Aunque es propuesta como un rasgo de personalidad estable en el tiempo puede variar a lo largo del ciclo vital de los seres humanos (Strathman et al., 1994). Por ejemplo, si una persona de bajos recursos gana la lotería podría dejar de preocuparse por los resultados inmediatos de sus acciones (organizarse para llegar a fin de mes) y pasar a enfocarse en las consecuencias distantes (por ejemplo, dónde va a construir su casa o qué va a hacer en vacaciones)."
  },
  {
    title: "Propiedades psicométricas del ChildrenBehaviorCheckList (CBCL)-Versión 1 ⅕-5 en una muestra representativa uruguaya Análisis de confiabilidad y validez utilizando datos de la ENDIS",
    authors: "Lucía Alvarez-Nuñez, Meliza Gonzalez, A Vásquez-Echeverría",
    ...
    abstract: `El Child Behavior Check List (CBCL1 ⅕-5) es un instrumento de screening que evalúa los problemas conductuales, emocionales y sociales de los niños de un año y medio a cinco años de edad. Es completada por los padres biológicos, sustitutos o referentes de los niños, quienes a su vez, informan sobre su situación laboral actual y relación con el/la niño/a (Achenbach, 1991; Achenbach & Rescorla, 2000). El CBCL posee versiones para otras edades y es parte del sistema de evaluación del comportamiento ASEBA. 

		La versión más actualizada del CBCL es la publicada en Achenbach & Rescorla (2000) para niños de 1.5 a 5 (en adelante 1⅕-5) años de edad. El CBCL 1⅕-5 está conformado por 100 ítems de los cuales 99 son cerrados y el último es de respuesta abierta. Los primeros 99 ítems tienen tres valores de respuestas (0= No es cierto; 1= En cierta manera, algunas veces; 2= Muy cierto o cierto a menudo), en alguno de los cuales los respondientes pueden brindar información descriptiva. En el último ítem los participantes detallan si el niño presenta algún problema no contemplado previamente en el instrumento.`
  },
  {
    title: "Propiedades psicométricas del Ages&StagesQuestionnaires: Social-Emotional (ASQ-SE) en una muestra representativa uruguaya",
    authors: "Lucía Alvarez-Nuñez, Meliza Gonzalez, A Vásquez-Echeverría",
    journal: "Análisis de confiabilidad y validez utilizando datos de la ENDIS. Montevideo, Uruguay",
    time: "2018",
  ...
  },
  {
    ...
    journal: "Documentos del IECON: Documentos de Trabajo",
    time: "2025",
    ...
    abstract: "Las características de la personalidad, otros rasgos psicológicos y las habilidades cognitivas, se han relacionado consistentemente con el desempeño académico. Sin embargo, existe evidencia empírica limitada sobre cómo estos factores influyen conjuntamente en las decisiones de abandono escolar. Este trabajo examina la relación entre los rasgos de la personalidad en el modelo de los cinco grandes (big five en inglés), la consideración de las consecuencias futuras y la inteligencia fluida, en las decisiones de abandono escolar entre estudiantes de segundo año de las facultades de Ciencias Económicas y de Administración y Psicología de la Universidad de la República. Utilizamos información de una muestra de la cohorte 2018 para analizar los patrones de abandono a través de modelos de variable dependiente cualitativa. Nuestros hallazgos revelan que los rasgos de personalidad y la inteligencia fluida están significativamente asociados con las decisiones de abandono escolar, aunque sus efectos varían según la disciplina académica. Además, identificamos patrones distintos de influencia de los rasgos de personalidad y las habilidades cognitivas en las tipologías de abandono instruccional y sistémico. Estos hallazgos contribuyen a la creciente literatura sobre los determinantes psicológicos de los resultados educativos y ofrecen perspectivas para las políticas de educación superior dirigidas a mejorar la retención estudiantil."
  },
  {
  ...
  {
    title: "¿La consideración de las consecuencias futuras media la relación entre el ingreso socioeconómico y el índice de masa corporal?",
    authors: "Lucía Alvarez-Nuñez, Alejandro Vásquez Echeverría",
    journal: "Revista Argentina de Ciencias del Comportamiento (RACC) 12 (1), 92-93",
    time: "2020",
    link: "https://scholar.google.com/citations?view_op=view_citation&hl=es&user=WpzOV1EAAAAJ&citation_for_view=WpzOV1EAAAAJ:UebtZRa9Y70C",
    abstract: ""
  }
];
